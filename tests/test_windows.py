...
WINDOWS_OSDATA_CASES = [
    ...
    # Additional kernel/build formatted strings
    (
    ...
    (
        ...
        OSData(
            ...
            confidence=0.85,
            evidence={"hit": "windows", "nt_version": "6.1"},
            os_key="cpe:2.3:o:microsoft:windows:6.1.7601:*:*:*:*:*:x64:*",
        ),
    ),
    (
    ...
    # Legacy generator coverage (windows)
    (
    ...
    (
        ...
        OSData(
            ...
            confidence=0.7,
            evidence={"hit": "windows"},
            os_key="cpe:2.3:o:microsoft:windows_7:*:*:*:*:*:*:*:*",
        ),
    ),
]
